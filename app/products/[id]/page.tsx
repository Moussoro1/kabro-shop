    ...
    return (
      <div id="product-not-found" className="min-h-screen bg-paper text-charcoal flex flex-col">
        ...
        <main className="flex-1 max-w-xl w-full mx-auto px-4 py-16 flex flex-col items-center justify-center text-center">
          <div className="border border-sand/80 rounded-xl p-8 shadow-sm w-full bg-paper">
            ...
            <Link
              ...
              className="inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-accent text-charcoal font-semibold text-sm rounded-lg"
            >
