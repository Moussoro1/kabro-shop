...
export function CartEmptyState(): ReactElement {
  return (
    <section
      id="cart-empty-state"
      className="border border-sand rounded-lg p-8 sm:p-12 text-center my-8 bg-paper max-w-xl mx-auto shadow-sm"
    ...
    >
      ...
      <h2
        id="cart-empty-title"
        className="font-display text-xl sm:text-2xl font-bold text-charcoal mb-2"
      >
      ...
      <p className="text-xs sm:text-sm text-charcoal/70 mb-6 max-w-md mx-auto leading-relaxed">
        ...
        produits pour découvrir les créations artisanales, vêtements et cosmétiques
