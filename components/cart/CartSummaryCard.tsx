...
export function CartSummaryCard({
  ...
  return (
    <section
      ...
      className={`bg-paper border border-sand rounded-lg p-5 sm:p-6 sticky top-20 shadow-sm ${className ?? ""}`}
      aria-labelledby="cart-summary-heading"
    >
      <h2
        id="cart-summary-heading"
        className="font-display font-bold text-lg sm:text-xl text-charcoal border-b border-sand pb-3 mb-4"
      >
      ...
      <div className="border-t border-b border-sand py-4 mb-6 bg-sand/15 -mx-5 sm:-mx-6 px-5 sm:px-6">
        <div className="flex justify-between items-baseline gap-2">
          <div>
            <span className="font-display font-bold text-base sm:text-lg text-charcoal block">
              Total à payer
            </span>
      ...
      <div className="space-y-3">
        ...
        <Link
          ...
          className="w-full min-h-[48px] h-12 px-5 bg-accent text-charcoal font-display font-bold text-base rounded-md inline-flex items-center justify-center gap-2 hover:brightness-95 active:scale-[0.99] transition-all shadow-xs cursor-pointer focus-visible:outline-2 focus-visible:outline-accent focus-visible:outline-offset-2"
        >
        ...
        <Link
          ...
          className="w-full min-h-[44px] py-2.5 px-4 border border-sand bg-paper hover:bg-sand/30 active:bg-sand/50 text-charcoal font-semibold text-xs sm:text-sm rounded-md inline-flex items-center justify-center gap-2 transition-colors cursor-pointer focus-visible:outline-2 focus-visible:outline-primary focus-visible:outline-offset-1"
        >
